...
public class startup2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song = MediaPlayer.create(startup2.this,R.raw.tap);
        gameover = MediaPlayer.create(startup2.this,R.raw.gameover);
        bgsong = MediaPlayer.create(startup2.this,R.raw.bg);

        SharedPreferences preferences = getSharedPreferences("PREFS", 0);
        bestscore1 = preferences.getInt("highscore", 0);
        ...
        tv_score.setText("SCORE: " + currentscore1);

        tv_best = (TextView) findViewById(R.id.tv_best);
        tv_best.setText("BEST: " + bestscore1);
        ...
        timer = new CountDownTimer(15000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(startup2.this, "TIME UP!", Toast.LENGTH_SHORT).show();
                ...
                if (currentscore1 > bestscore1) {
                    ...
                    editor.putInt("highscore", bestscore1);
    ...
    private void endGame() {
        ...
        Toast.makeText(startup2.this, "GAME OVER!", Toast.LENGTH_SHORT).show();
        // gameover.stop();
        gameover.start();
        bgsong.stop();
        SendUserToGameOver();
